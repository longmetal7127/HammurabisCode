...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.1).withKV(4.4475).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.18502).withKI(0).withKD(0)
        .withKS(0).withKV(0.12257);
    ...
    public static final CANBus kCANBus = new CANBus("main_canivore", "./logs/example.hoot");
    ...
    private static final double kSteerGearRatio = 46.4236453;
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.0546875);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.34619140625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.607666015625);
