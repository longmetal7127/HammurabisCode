 ...
 * command-based.
 * Patched by 7127 to support strange simgui enumeration
 *
 * @see XboxController
 */
@SuppressWarnings("MethodName")
public class CommandGamesirController extends CommandGenericHID {
  private final XboxController m_hid;

  public enum SimButton {
    /** A button. */
    kA(1),
    /** B button. */
    kB(2),
   ...
   *             plugged into.
   */
  public CommandGamesirController(int port) {
    super(port);
  ...
  public Trigger a(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kA.value : XboxController.Button.kA.value, loop);
  }
  ...
  public Trigger b(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kB.value : XboxController.Button.kB.value, loop);
  }
  ...
  public Trigger x(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kX.value : XboxController.Button.kX.value, loop);
  }
  ...
  public Trigger y(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kY.value : XboxController.Button.kY.value, loop);
  }
  ...
  public Trigger leftBumper(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kLeftBumper.value : XboxController.Button.kLeftBumper.value, loop);
  }
  ...
  public Trigger rightBumper(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kRightBumper.value : XboxController.Button.kRightBumper.value, loop);
  }
  ...
  public Trigger back(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kBack.value : XboxController.Button.kBack.value, loop);
  }
  ...
  public Trigger start(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kStart.value : XboxController.Button.kStart.value, loop);
  }
  ...
  public Trigger leftStick(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kLeftStick.value : XboxController.Button.kLeftStick.value, loop);
  }
  ...
  public Trigger rightStick(EventLoop loop) {
    return button(RobotBase.isSimulation() ? SimButton.kRightStick.value : XboxController.Button.kRightStick.value, loop);
  }
  ...
  public Trigger leftTrigger(double threshold, EventLoop loop) {
    return axisGreaterThan(RobotBase.isSimulation() ? SimAxis.kLeftTrigger.value : XboxController.Axis.kLeftTrigger.value, threshold, loop);
  }
  ...
  public Trigger rightTrigger(double threshold, EventLoop loop) {
    return axisGreaterThan(RobotBase.isSimulation() ? SimAxis.kRightTrigger.value : XboxController.Axis.kRightTrigger.value, threshold, loop);
  }
  ...
  public double getLeftX() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kLeftX.value) : m_hid.getLeftX();
  }
  ...
  public double getRightX() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kRightX.value) : m_hid.getRightX();
  }
  ...
  public double getLeftY() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kLeftY.value) : m_hid.getLeftY();
  }
  ...
  public double getRightY() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kRightY.value) : m_hid.getRightY();
  }
  ...
  public double getLeftTriggerAxis() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kLeftTrigger.value) : m_hid.getLeftTriggerAxis();
  }
  ...
  public double getRightTriggerAxis() {
    return RobotBase.isSimulation() ? getRawAxis(SimAxis.kRightTrigger.value) : m_hid.getRightTriggerAxis();
  }
}
