...
// This class was adapted from the WPILib ElevatorSim class to allow simulating
// elevators that are not strictly vertical, such as the one in our robot.
...
public class TiltedElevatorSim extends LinearSystemSim<N2, N1, N2> {
        ...
        NumericalIntegration.rkdp(
            (x, _u) -> {
              ...
              if (m_simulateGravity) {
                xdot = xdot.plus(VecBuilder.fill(0, -9.8/4.0));
              }
              return xdot;
            },
            currentXhat,
